...
// Function: sumOfOddNodes
// Purpose: Recursively calculate the sum of all odd-valued nodes in a binary tree.
// Input: Pointer to the root node of the binary tree
// Output: Sum of all odd node values in the tree
int sumOfOddNodes(BTNode *node) {
    ...
    // If the current node's value is odd, include it in the sum
    int current = (node->item % 2 != 0) ? node->item : 0;
